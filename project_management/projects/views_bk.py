    ...
    if request.method == 'POST':
        ...
        if request_form.is_valid() and schedules_form.is_valid():
            ...
            if request.user.has_perm(
                ...
                # email_message += "<table width='50%'><tr><td></br>Requested by</td><td>:</td><td>"+ user_name + "</td></tr>"
                # email_message += "<tr><td></br>Requested on</td><td>:</td><td>"+request_date+"</td></tr>"
                # email_message += "<tr><td></br>Business Unit</td><td>:</td><td>"+bus_unit+"</td></tr>"
                # email_message += "<tr><td></br>Delivery Centre</td><td>:</td><td>"+delivery_centre+"</td></tr>"
                # email_message += "<tr><td></br>Project Name</td><td>:</td><td>"+project_name+"</td></tr>"
                # email_message += "<tr><td></br>Project Category</td><td>:</td><td>" + project_category +"</td></tr>"
                # email_message += "<tr><td></br>Project Type</td><td>:</td><td>"+project_type+"</td></tr>"
                # email_message += "<tr><td></br>Expected Start Date</td><td>:</td><td>"+expected_start_date+"</td></tr>"
                # email_message += "<tr><td></br>Expected End Date</td><td>:</td><td>"+expected_end_date+"</td></tr>"
                # email_message += "<tr><td></br>Estimated Efforts(man-days)</td><td>:</td><td>"+estimated_efforts+"</td></tr>"
                # email_message += "<tr><td></br>Objectives</td><td>:</td><td>"+objective+"</td></tr></table></body></html>"
                # email_message += 'Project Approval Status'
